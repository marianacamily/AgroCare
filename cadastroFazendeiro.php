...
?>
    <div class="cadastro">
        ...
        <form action="cadastroFazendeiro.php" method="POST" id="cadastroForm">
            ...
            <label>Senha:</label>
            <input type="password" id="senhaT" name="senha_teste" required>

            <label>Confirmar senha: </label>
            <input type="password" onchange ="validarSenhas()" id= "senhaF" name="senha_Fazendeiro" pattern="^(?=.*[!@#$%^&*])(.{8,})$" required><br><br>
